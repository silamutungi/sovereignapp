...
| 5 | Live example | One real app, generated by Sovereign, with "Built with Visila" link — see the output before committing |
...
| 10 | "Built with Visila" badge | This page is proof of concept |
...
## "Built with Visila" badge spec

### What it is

A small, permanent, unobtrusive badge on the landing page itself that demonstrates dog-fooding. The page was built by Sovereign's own Standards Engine. The badge links to a dedicated "Built with Visila" showcase page (future feature) or back to the top of the landing page for now.
...
5. **No showcase page.** The "Built with Visila" badge links to `#` for now. The showcase (`/built-with-sovereign`) is a separate feature.
...
- [ ] At least 3 organic "Built with Visila" mentions (badge drives word of mouth)
