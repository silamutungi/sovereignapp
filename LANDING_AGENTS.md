...
- The "Built with Sovereign" badge floats in its own 40px vertical breathing room in the footer
...
3. **The "Built with Sovereign" badge.** When someone discovers the landing page itself is a Sovereign app, that is a share moment. "Wait, this page was built with the tool?" The badge at the bottom is the reveal.

### What is the "Built with Sovereign" badge strategy?
...
Growth mechanism: every app generated by Sovereign includes an optional "Built with Sovereign" badge (user can remove it). The landing page's badge is the canonical example — it shows users what the badge looks like and how it's used. When users leave the badge in their own apps, they create a distributed network of Sovereign discovery surfaces. One click on any badge brings a visitor to `sovereignapp.dev`. The badge is not a tracking pixel. It is a doorway.

Badge copy options tested in order of preference:
1. `✦ Built with Sovereign` — clean, specific, curiosity-inducing
...
| "Built with Sovereign" badge | Static | Never changes |
...
<noscript>
  <div style="padding: 2rem; text-align: center; font-family: Georgia, serif;">
    ...
    <p>Questions? <a href="mailto:hello@sovereignapp.dev">hello@sovereignapp.dev</a></p>
  </div>
</noscript>
```
...
When users share their "Built with Sovereign" apps and those apps carry the badge that links back to `sovereignapp.dev`, those are natural backlinks from real projects on real domains. This is a better long-term SEO strategy than any content calendar.
...
- Text: "Built with Sovereign" in DM Mono, 11px, `#6b6862`, letter-spacing 0.02em
...
**Phase 1 (now):** `https://sovereignapp.dev` — back to the landing page. This is acceptable because the landing page is itself an example of a Sovereign-built product. The loop is honest.

**Phase 2:** `https://sovereignapp.dev/built-with-sovereign` — a showcase page listing apps built with Sovereign, their stacks, the founders' names. This is the destination worth building when there are 20+ real apps to show.
...
The 15 standards in SOVEREIGN_STANDARDS.md are not rules Sovereign applies to other people's apps while exempting its own. This page was built using the same generation pipeline, the same design tokens, the same quality checklist. The badge is the receipt.
